...
CONTAINERS = {}
ALLOWED_IMAGES = ['ubuntu:latest', 'debian:stable', 'fedora:latest', 'quay.io/devfile/base-developer-image:ubi10-latest', 'mcr.microsoft.com/devcontainers/base:ubuntu-22.04']
